  ...
  return (
    <div className="card-fluid">
      <img
        ...
        alt="https://github.com/aalexandr6/FastMunchies"
      ></img>
      <div class="card-body">
        ...
        <p class="card-text card-subtitle mb-2 text-muted">
          Recent collabartion with other develops to make a application with a
          menu and login
        </p>
      </div>
      ...
      <div className="card-fluid">
        <div class="card-body">
          <img
            src={project2}
            class="card-img-top"
            alt="https://github.com/aalexandr6/Trans-Line"
          ></img>
          ...
          <p class="card-text card-subtitle mb-2 text-muted">
            A website for s trucking business to be able to login as admin, show
            services and keep track of drivers
          </p>
        </div>
      </div>
      <div className="card-fluid">
        <div class="card-body">
          <img
            src={project3}
            class="card-img-top"
            alt="https://github.com/amsudekum/DateNightMeal"
          ></img>
          ...
          <p class="card-text card-subtitle mb-2 text-muted">
            A Quiz and recipe application to choosing a date night meal a little
            bit easier!
          </p>
        </div>
      </div>
      <div className="card-fluid">
        <div class="card-body">
          ...
          <p class="card-text card-subtite mb-2 text-muted">
            {" "}
            A note-taking application to take some quick noted (helps me study)
          </p>
        </div>
      </div>
      <div className="card-fluid">
        <div class="card-body">
          ...
          <p class="card-text card-subtitle mb-2 text-muted">
            Application to make quick password
          </p>
        </div>
      </div>
      <div className="card-fluid">
        <div class="card-body">
          ...
          <p class="card-text card-subtitle mb-2 text-muted">
            First time working with an API and making this application that get
      ...
      <div className="card-fluid">
        <div class="card-body">
          ...
          <p class="card-text card-subtite mb-2 text-muted">
            First time ever trying to get a working html working with no errors
          </p>
        </div>
      </div>
    </div>
